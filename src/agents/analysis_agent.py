...
class AnalysisAgent(BaseAgent):
    """Agent for IT outage root cause analysis and investigation"""
    ...
    async def run(self, messages=None, *, thread=None, **kwargs):
        ...
        response_message = ChatMessage(role="assistant", text=response_content, author_name="analysis-agent")
        
        return AgentRunResponse(messages=[response_message], response_id=f"analysis-{hash(message_text) % 10000}")
